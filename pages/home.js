...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen h-full w-full overflow-hidden flex flex-col items-center justify-center bg-brand-background ">
      ...
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-10">
          <div className="relative z-1 md:max-w-3xl w-full bg-gray-900/90 filter backdrop-blur-sm py-4 rounded-md px-2 md:px-10 flex flex-col items-center opacity-90">
            ...
            onClick={()=> window.open("http://cyberwojakz.io")}
            ...
            <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
              ...
              <img
                ...
                <img
                  src="/images/banner cyber 2.png"
                  className="relative block w-full min-h-fit object-cover opacity-100"
                />  
      ...
      <img
        className='animate-pulse-slow  absolute photo9 z-20 right-[100px] top-[5500px]'
        src='/images/topArrow.png'
        onClick={() => scrollTop()}
      />
      <img
        className='animate-pulse-slow absolute photo9 z-20 left-[100px] top-[5500px]'
        src='/images/topArrow.png'
        onClick={() => scrollTop()}
      />
      <div className='w-100 h-100'>
        ...
        <img
          src="/images/Synthwave_floor2.png"
          className="animate-pulse-slow left-[0px] item-center absolute top-[5000px] inset-auto block w-full min-h-full object-cover"
        />
                <img
            src="/images/Scene.png"
            className="absolute opacity-100 top-[5890px] left-[0px]"
        />
      </div>
    </div>
